...
install -p -D -m 644 heat_dashboard/local_settings.d/_1699_orchestration_settings.py %{buildroot}%{_datadir}/openstack-dashboard/openstack_dashboard/local_settings.d

install -p -D -m 644 heat_dashboard/conf/heat_policy.yaml %{buildroot}%{_datadir}/openstack-dashboard/openstack_dashboard/heat_policy.yaml
install -p -D -m 644 heat_dashboard/conf/default_policies/heat.yaml %{buildroot}%{_datadir}/openstack-dashboard/openstack_dashboard/default_policies/heat.yaml
