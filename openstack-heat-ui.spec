...
%{?dlrn: %global tarsources heat-dashboard}
%{!?dlrn: %global tarsources heat_dashboard}
...
%changelog
# REMOVEME: error caused by commit https://opendev.org/openstack/heat-dashboard/commit/bef1931f2441b44f61f63f52e594119d8f85ce62
